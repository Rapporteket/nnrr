...
#' @export
#'
nnrrFigAndelGrvar <- function(RegData, valgtVar="opplevd_nytte_beh_6mnd",
                              ...
                              grtittel="Behandling i spesialisthelsetjenesten")
{
  ...
  valgtVar="opplevd_nytte_beh_6mnd"; valgtVar="opplevd_nytte_beh_12mnd";
  datoFra='2022-10-01'; datoTil='2023-09-30';
  enhetsUtvalg=1; datovar="dato_oppfolg";
