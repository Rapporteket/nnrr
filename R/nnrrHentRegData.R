...
nnrrHentRegData <- function(datoFra = '2017-01-01', datoTil = '2099-01-01') {
  ...
  legeskjema <-
    readr::read_csv2(
        paste0("C:/Users/kth200/OneDrive - Helse Nord RHF/Dokumenter/regdata/nnrr/data_2025-08-11_0923.csv"))
  pasientsvar_pre <-
    readr::read_csv2(
      paste0("C:/Users/kth200/OneDrive - Helse Nord RHF/Dokumenter/regdata/nnrr/data_2025-08-11_0932.csv"))
  pasientsvar_post <-
    readr::read_csv2(
      paste0("C:/Users/kth200/OneDrive - Helse Nord RHF/Dokumenter/regdata/nnrr/data_2025-08-11_0939.csv"))
  pasientsvar_post2 <-
    readr::read_csv2(
      paste0("C:/Users/kth200/OneDrive - Helse Nord RHF/Dokumenter/regdata/nnrr/data_2025-08-11_0942.csv"))
