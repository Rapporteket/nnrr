...
lagKodebok <- function() {
  varnavn_1b <- xlsx::read.xlsx(system.file("extdata", "kodebokNNRR25052018.xlsx", package = "nnrr"),
    sheetIndex = 4,
    encoding = "UTF-8", stringsAsFactors = F
  )
  varnavn_1a <- xlsx::read.xlsx(system.file("extdata", "kodebokNNRR25052018.xlsx", package = "nnrr"),
    sheetIndex = 3,
    encoding = "UTF-8", stringsAsFactors = F
  )
  varnavn_2 <- xlsx::read.xlsx(system.file("extdata", "kodebokNNRR25052018.xlsx", package = "nnrr"),
    sheetIndex = 2,
    encoding = "UTF-8", stringsAsFactors = F
  )
