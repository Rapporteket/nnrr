...
RegDataAll <- RegData
RegData <- RegData[which(RegData$Aar >= 2019 & RegData$Aar <= rap_aar), ]
Oppf_data <- RegDataAll[which(RegDataAll$aar_oppfolg>= 2019 & RegDataAll$aar_oppfolg <= rap_aar), ]
...
write.csv2(Indikatorer, "~/regdata/nnrr/behandlingskvalitet/beh_kval_2024.csv",
           row.names = F)
