...
format_ut <- ".pdf"
figfolder <- "C:/GIT/nnrr/inst/indikatorer_2022/"
...
dg <- readr::read_csv2("C:/GIT/data/nnrr/dg_nnrr_raa.csv",
...
dg_ny <- readr::read_csv2("C:/GIT/data/nnrr/Dekningsgrad 2021 NNRR.csv",
                          locale = readr::locale(encoding = "Latin1"))
...
write.csv2(Indikatorer, paste0('C:/GIT/data/nnrr/indikatorer_nnrr_', Sys.Date(), '.csv'),
