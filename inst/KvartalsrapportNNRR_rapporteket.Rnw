...
\caption{Andel pasienter som 6 og 12 mnd etter utredning/behandling er tilbake i arbeid.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}tilbake_i_arbeid_tverrfaglig.pdf}
\caption{Andel pasienter som 6 og 12 mnd etter utredning/behandling er tilbake i arbeid blant de tverrfaglig utredede.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}mer_arbeid.pdf}
\caption{Andel pasienter som 6 og 12 mnd etter utredning/behandling er tilbake i arbeid eller har lavere grad sykemelding.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}mer_arbeid_tverrfaglig.pdf}
\caption{Andel pasienter som 6 og 12 mnd etter utredning/behandling er tilbake i arbeid eller har lavere grad sykemelding blant de tverrfaglig utredede.}
\end{figure}
