...
\title{Figurer og tabeller til 2022 årsrapport for NNRR}
\author{NNRR}
...
icd10 <- read.table('~/mydata/nnrr/icd10.csv', sep=';',
                    header=T, stringsAsFactors = F, fileEncoding = 'UTF-8')
# icd10 <- read.table(system.file(file='extdata/icd10.csv', package='nnrr'),
#                     sep=';', header=T, stringsAsFactors = F,
#                     fileEncoding = 'UTF-8')
# system.file(file='extdata/icd10.csv', package='nnrr')

figstr <- 0.61
tmp <- Sys.setlocale(category = "LC_ALL", locale = "nb_NO.UTF-8")

figfolder <- "~/mydata/nnrr/figurer_aarsrapp_2022/"
if (!dir.exists(figfolder)) {
  dir.create(figfolder)
}
tabfolder <- "~/mydata/nnrr/tabeller_aarsrapp_2022/"
...
#                  datoFra = paste0(rap_aar-1, "-07-01"), datoTil = paste0(rap_aar, "-06-30"), outfile = outfile)
# }
FigData <- nnrr::nnrrBeregnAndeler(RegData, valgtVar=valgtVar, datoFra=paste0(rap_aar-1, "-07-01"),
