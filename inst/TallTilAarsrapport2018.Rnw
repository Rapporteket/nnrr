...
RegDataAll <- RegData
RegData <- RegData[which(RegData$Aar >= 2018 & RegData$Aar <= 2018), ]
...
print(xtable::xtable(Tabell_pasrapp_beh_komm_1, digits=0, caption='Pasientrapportert behandling på nakke - og ryggpoliklinikken. Del 1. Ikke mulig å skille 0 fra ikke besvart.'), include.rownames=FALSE)

print(xtable::xtable(Tabell_pasrapp_beh_komm_2, digits=0, caption='Pasientrapportert behandling på nakke - og ryggpoliklinikken. Del 2. Ikke mulig å skille 0 fra ikke besvart.'), include.rownames=FALSE)
