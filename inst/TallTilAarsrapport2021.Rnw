...
RegData <- merge(RegData, pasientsvar_post2, by.x = 'SkjemaGUID', by.y = 'HovedskjemaGUID', suffixes = c('', '_post2'), all.x = TRUE)
...
tab_oppf_alle <- RegDataAll %>% group_by(SykehusNavn) %>%
...
print(xtable::xtable(tab_oppf_alle, digits=0, align=c('l', 'l', 'l', rep('r', ncol(tab_oppf_alle)-2)), caption = paste0('Oversikt over oppfølgingsprosent per enhet, antall aktuelle i parentes. 6mnd. oppf. gjelder konsultasjoner i perioden 1.juli ', rap_aar-1, ' til 30. juni ', rap_aar, ", mens 12mnd. oppf. gjelder konsultasjoner i ", (rap_aar-1)), include.rownames=FALSE, sanitize.text.function = identity))
...
# }
outfile <- "Smerte_i_aktivitet_basis.pdf"
...
outfile <- "Smerte_i_aktivitet_6mnd.pdf"
...
outfile <- "Smerte_i_aktivitet_12mnd.pdf"
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{Smerte_i_ro_basis.pdf}
\caption{Smerte i hvile, skala fra 0-10 hvor 10 er verst}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{Smerte_i_ro_6mnd.pdf}
\caption{Smerte i hvile, skala fra 0-10 hvor 10 er verst}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{Smerte_i_ro_12mnd.pdf}
\caption{Smerte i hvile, skala fra 0-10 hvor 10 er verst}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{Smerte_i_aktivitet_basis.pdf}
\caption{Smerte i aktivitet, skala fra 0-10 hvor 10 er verst}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{Smerte_i_aktivitet_6mnd.pdf}
\caption{Smerte i aktivitet, skala fra 0-10 hvor 10 er verst}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{Smerte_i_aktivitet_12mnd.pdf}
\caption{Smerte i aktivitet, skala fra 0-10 hvor 10 er verst}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{andel_kvinner.pdf}
